...
namespace Liftraza.Infrastructure.Data;

public sealed class LiftrazaDbContext : IdentityDbContext<ApplicationUser>
{
    public LiftrazaDbContext(DbContextOptions<LiftrazaDbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
		...
		// ExerciseCatalogEntry (configuration + HasData seed in a separate class)
