...
/// <summary>
/// Session inside a routine (e.g. "Day 1 - Push").
/// It can be created empty and completed later (business rule 4.2).
/// </summary>
public sealed class WorkoutSession : Entity
{
	...
	/// (The root aggregate reassigns the order when the copy is added to the routine.)
	/// </summary>
